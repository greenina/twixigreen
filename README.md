...
My page shows the wish list of the user. Hovering on the non-eco-friendly item, Bukkuk recommends some other eco-friendly items with same function. For eco-friendly item, Bukkuk says he likes the product. You can cancel heart in the wish list directly, and the items in the wish list determines the status of Bukkuk(such as dancing)
